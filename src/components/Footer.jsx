        ...
        <div className="container">
            ...
            <div className="row mt-5">
                <div className="col-6 col-lg-3 px-3">
                    ...
                    <span className="lead">Email: <a href="#" className='text-secondary'>support@shopmate.com</a></span>
                    <p className="lead my-2 d-flex"><strong>Phone:</strong><span className='ms-2 text-end'>+234-701-234-5678</span></p>
                </div>
                <div className="col-6 col-lg-3 px-3">
                ...
                <div className="col-6 col-lg-3 px-3">
                    ...
                    <p className="lead">To read our frequently asked question, <a href="#" className='btn px-0 text-decoration-underline'>click here</a></p>
                </div>
            </div>
            <p className="lead fw-semibold text-center mt-3">
                Copyright 
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-c-circle mx-1" viewBox="0 0 16 16">
