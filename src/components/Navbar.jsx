...
function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-md bg-body-tertiary  top-0 left-0 w-100">
      <div className="container position-relative py-3">
        ...
        <div className={`collapse navbar-collapse px-4 px-md-0 d-none d-md-block md-menu`} id="navbarSupportedContent">
          <ul className="navbar-nav mb-2 mb-md-0">
            <li className="nav-item">
              <a className="nav-link fw-semibold fw-md-normal" aria-current="page" href="#">Shop</a>
            </li>
            <li className="nav-item">
              <a className="nav-link fw-semibold fw-md-normal" href="#">About</a>
            </li>
            <li className="nav-item">
              <a className="nav-link fw-semibold fw-md-normal" href="#">FAQ</a>
            </li>
          </ul>
        </div>
        ...
        <a className="navbar-brand text-black fw-semibold text-uppercase d-flex align-items-center" href="#homepage">
        ...
        {/* Cart and User */}
        <div className=''>
        <a href="#cart" className='btn btn-sm fs-6 text-muted'>
        ...
        <a href="#user" className='btn btn-sm fs-6 text-muted'>
      ...
      <div className={`${showMenu} container d-block d-md-none mt-2`}>
        <div className={`collapse navbar-collapse`} id="navbarSupportedContent">
          <ul className="navbar-nav mb-2 mb-md-0 flex-row justify-content-center">
            <li className="nav-item">
              <a className="nav-link fw-semibold px-2" aria-current="page" href="#">Shop</a>
            </li>
            <li className="nav-item">
              <a className="nav-link fw-semibold px-2" href="#">About</a>
            </li>
            <li className="nav-item">
              <a className="nav-link fw-semibold px-2" href="#">FAQ</a>
            </li>
          </ul>
        </div>
      </div>
